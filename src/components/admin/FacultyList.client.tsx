        ...
        <main className="min-h-screen bg-gray-100 p-10">
          <div className="max-w-4xl mx-auto">
            <div className="flex justify-between items-center mb-6">
              <h1 className="text-2xl font-semibold text-gray-800">Gestionare facultati</h1>
              ...
              <ul className="divide-y divide-gray-200">
                {faculties.map((faculty) => (
                  <li key={faculty.id} className="px-6 py-4 flex items-center justify-between hover:bg-gray-50">
                    <div>
                      <h2 className="text-lg font-semibold text-gray-900">{faculty.nameRo}</h2>
                      <h4 className="text-md text-gray-600">{faculty.nameEn}</h4>
                    </div>
                    <div className="flex items-center">
                      <Link href={{ pathname: "faculties/update", query: { id: faculty.id, nameRo: faculty.nameRo, nameEn: faculty.nameEn, accountId: faculty.euplatescAccountId } }} passHref>
