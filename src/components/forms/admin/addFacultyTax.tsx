...
export default function AddFacultyTaxForm({faculties} : {faculties : Faculty[]}) {
    ...
    return (
        <main className="py-10 flex justify-center items-center min-h-screen bg-gray-100">
          <div className="w-full max-w-3xl p-8 bg-white rounded-lg shadow-lg transform transition duration-500 hover:scale-105">
            <h1 className="mb-6 text-3xl font-bold text-center text-gray-800">Adaugă Taxă Facultate</h1>
            ...
            <form onSubmit={handleSubmit(processForm)} className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex flex-col">
                ...
                />
                {errors.value && (
                    <p className="text-xs italic text-red-600 text-center">{errors.value.message}</p>
                  )}
                </div>
                ...
                <div className="flex flex-col">
                  ...
                  />
                  {errors.studyCycle && (
                    <p className="text-xs italic text-red-600 text-center">{errors.studyCycle.message}</p>
                  )}
              </div>
