...
import { z } from "zod";
import { createTaxDorm } from "@/actions/actions";
...
export default function AddTaxDormForm({dormitories} : {dormitories : StudentDorm[]}) {
          ...
          <div className="w-full max-w-3xl p-8 bg-white rounded-lg shadow-lg transform transition duration-500 hover:scale-105">
            ...
            <form onSubmit={handleSubmit(processForm)} className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex flex-col">
                ...
                />
                {errors.value && <p className="text-xs italic text-red-600 text-center">{errors.value.message}</p> }
              </div>
              ...
              <div className="col-span-2">
                ...
                >
                  <IoAddCircleOutline className="mr-2" /> Adauga
                </button>
              </div>
            </form>
          </div>
