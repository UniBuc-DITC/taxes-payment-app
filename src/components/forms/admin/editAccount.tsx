        ...
        <div className="w-full max-w-3xl p-8 bg-white rounded-lg shadow-lg transform transition duration-500 hover:scale-105">
          ...
          <form onSubmit={handleSubmit(processForm)} className="space-y-6">
            ...
            <div className="flex flex-col">
              ...
              {errors.description && <p className="text-xs italic text-red-600 text-center">{errors.description.message}</p>}
            </div>
            ...
            <div className="flex flex-col">
              ...
              />
              {errors.merchantId && <p className="text-xs italic text-red-600 text-center">{errors.merchantId.message}</p>}
            </div>
            ...
            <div className="flex flex-col">
              ...
              />
              {errors.secretKey && <p className="text-xs italic text-red-600 text-center">{errors.secretKey.message}</p>}
            </div>

            <button type="submit" className="w-full flex items-center justify-center px-4 py-2 text-white bg-blue-500 rounded hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition duration-300 ease-in-out">
